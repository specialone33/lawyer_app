                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contracts.update", [$contract->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('case_file_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="case_file_number" id="case_file_number" value="{{ old('case_file_number', $contract->case_file_number) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('registration_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="registration_date" id="registration_date" value="{{ old('registration_date', $contract->registration_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('contract_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="contract_type_id" id="contract_type_id" required>
                                @foreach($contract_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('contract_type_id') ? old('contract_type_id') : $contract->contract_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('contract_description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="contract_description" id="contract_description">{{ old('contract_description', $contract->contract_description) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('customers') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="customers[]" id="customers" multiple required>
                                @foreach($customers as $id => $customer)
                                    <option value="{{ $id }}" {{ (in_array($id, old('customers', [])) || $contract->customers->contains($id)) ? 'selected' : '' }}>{{ $customer }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('opponent') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="opponent" id="opponent" value="{{ old('opponent', $contract->opponent) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('signing_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="signing_date" id="signing_date" value="{{ old('signing_date', $contract->signing_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('lawyer') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="lawyer_id" id="lawyer_id" required>
                                @foreach($lawyers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('lawyer_id') ? old('lawyer_id') : $contract->lawyer->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('comments') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="comments" id="comments">{{ old('comments', $contract->comments) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('charging_expenses') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="charging_expenses" id="charging_expenses" value="{{ old('charging_expenses', $contract->charging_expenses) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('hours') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="hours" id="hours" value="{{ old('hours', $contract->hours) }}" step="1">
                            @if($errors->has('hours'))
                        ...
                        <div class="form-group {{ $errors->has('hourly_rate') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="hourly_rate" id="hourly_rate" value="{{ old('hourly_rate', $contract->hourly_rate) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('one_time_fees') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="one_time_fees_id" id="one_time_fees_id">
                                @foreach($one_time_fees as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('one_time_fees_id') ? old('one_time_fees_id') : $contract->one_time_fees->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('custom_one_time_fee_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="custom_one_time_fee_name" id="custom_one_time_fee_name" value="{{ old('custom_one_time_fee_name', $contract->custom_one_time_fee_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('custom_one_time_fee_value') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="custom_one_time_fee_value" id="custom_one_time_fee_value" value="{{ old('custom_one_time_fee_value', $contract->custom_one_time_fee_value) }}" step="0.01">
