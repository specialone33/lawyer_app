                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('telephone_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="telephone_1" id="telephone_1" value="{{ old('telephone_1', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('telephone_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="telephone_2" id="telephone_2" value="{{ old('telephone_2', '') }}">
