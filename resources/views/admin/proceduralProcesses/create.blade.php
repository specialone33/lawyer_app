        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.proceduralProcess.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.procedural-processes.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('proccess') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="proccess_id" id="proccess_id" required>
                                @foreach($proccesses as $id => $entry)
                                    <option value="{{ $id }}" {{ old('proccess_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('service_of_suit_days') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="service_of_suit_days" id="service_of_suit_days" value="{{ old('service_of_suit_days', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('service_of_suit_days_type') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\ProceduralProcess::SERVICE_OF_SUIT_DAYS_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="service_of_suit_days_type_{{ $key }}" name="service_of_suit_days_type" value="{{ $key }}" {{ old('service_of_suit_days_type', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('service_of_suit_before_after') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\ProceduralProcess::SERVICE_OF_SUIT_BEFORE_AFTER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="service_of_suit_before_after_{{ $key }}" name="service_of_suit_before_after" value="{{ $key }}" {{ old('service_of_suit_before_after', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('filing_motions_days') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="filing_motions_days" id="filing_motions_days" value="{{ old('filing_motions_days', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('filing_motions_type') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\ProceduralProcess::FILING_MOTIONS_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="filing_motions_type_{{ $key }}" name="filing_motions_type" value="{{ $key }}" {{ old('filing_motions_type', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('filing_motions_before_after') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\ProceduralProcess::FILING_MOTIONS_BEFORE_AFTER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="filing_motions_before_after_{{ $key }}" name="filing_motions_before_after" value="{{ $key }}" {{ old('filing_motions_before_after', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('filing_add_sentences_days') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="filing_add_sentences_days" id="filing_add_sentences_days" value="{{ old('filing_add_sentences_days', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('filing_add_sentences_type') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\ProceduralProcess::FILING_ADD_SENTENCES_TYPE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="filing_add_sentences_type_{{ $key }}" name="filing_add_sentences_type" value="{{ $key }}" {{ old('filing_add_sentences_type', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('filing_add_sentences_before_after') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\ProceduralProcess::FILING_ADD_SENTENCES_BEFORE_AFTER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="filing_add_sentences_before_after_{{ $key }}" name="filing_add_sentences_before_after" value="{{ $key }}" {{ old('filing_add_sentences_before_after', '') === (string) $key ? 'checked' : '' }} required>
