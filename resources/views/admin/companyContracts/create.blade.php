        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.companyContract.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.company-contracts.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('company_type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="company_type_id" id="company_type_id">
                                @foreach($company_types as $id => $entry)
                                    <option value="{{ $id }}" {{ old('company_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('alterations') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="alterations[]" id="alterations" multiple>
                                @foreach($alterations as $id => $alteration)
                                    <option value="{{ $id }}" {{ in_array($id, old('alterations', [])) ? 'selected' : '' }}>{{ $alteration }}</option>
                                @endforeach
                            </select>
